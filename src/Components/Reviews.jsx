  ...
  return (
    ...
    >
          ...
          <div>
            ...
            <div className="overflow-hidden">
              ...
              >
                ...
                <br />
                <span style={{ WebkitTextStroke: '1.5px #FF2D00', color: 'transparent' }}>Say</span>
              </h2>
            </div>
          </div>
      ...
      <div className="flex flex-col gap-4 marquee-wrap">
        <MarqueeRow items={row1} direction={1} activeId={activeId} onCardClick={handleCardClick} />
        <MarqueeRow items={row2} direction={-1} activeId={activeId} onCardClick={handleCardClick} />
      </div>
